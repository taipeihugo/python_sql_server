...
from update_data import update_data_window          # 修改資料的視窗函式
...
def main_window():
    ...
    """
    app = tk.CTk()              # 建立主視窗物件
    app.geometry("300x450")     # 設定視窗大小為 300x450 像素
    ...
    tk.CTkButton(app, text="修改資料", command=update_data_window).pack(pady=10)       # 按鈕：修改資料
